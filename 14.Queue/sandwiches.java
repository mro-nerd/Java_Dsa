...
public class sandwiches {
    public static void main(String[] args) {
        ...
        System.out.println("Number of students unable to eat: " + solution.countStudents(students1, sandwiches1));
        // Expected Output: 0

        // Test case 2
        int[] students2 = { 1, 1, 1, 0, 0, 1 };
        int[] sandwiches2 = { 1, 0, 0, 0, 1, 1 };
        System.out.println("Number of students unable to eat: " + solution.countStudents(students2, sandwiches2));
        // Expected Output: 3
    }
}
